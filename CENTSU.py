...
def tsu():
    clear()
    print(f'{G1}[{A}1{G1}]{G1} Philipines CLONE')
    ...
    if xen in ['1']:
        ...
        tsu()
#__________________PH DEF____________#
def ph():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{A} 099{G}/{A}094{G}/{A}091{G}/{A}095');linex()
...
def file():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{G1} /{A}sdcard{G1}/{A}CENT.txt');linex()
